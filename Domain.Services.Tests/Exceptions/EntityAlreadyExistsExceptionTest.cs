namespace Prizma.Domain.Services.Tests.Exceptions
{
    ...
    /// <summary>
    /// The entity already exists exception test.
    /// </summary>
    public class EntityAlreadyExistsExceptionTest
    {
        ...
        /// </summary>
        private readonly EntityAlreadyExistsException exception;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EntityAlreadyExistsExceptionTest"/> class.
        /// </summary>
        public EntityAlreadyExistsExceptionTest()
        {
            this.exception = new EntityAlreadyExistsException(this.type, this.id);
        }
